...
//            })
        ...
        methods:{
            ...
            handleCommand(command) {
              ...
              if(command == 'shanghai'){
                  window.location.href="http://106.14.180.122:68/administrator/#/login?n="+us.name+"&p="+us.token;
              }
              if(command == 'beijing'){
                window.location.href="http://47.101.54.147:68/administrator/#/login?n="+us.name+"&p="+us.token;
              }
            },
            // 侧边栏折叠
            collapseChage(){
