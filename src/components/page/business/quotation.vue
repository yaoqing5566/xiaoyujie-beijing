<template>
  <div class="table">
    ...
    <!-- 编辑弹出框   :close-on-click-modal="false" -->
...
<script>
  export default {
    ...
    created() {
      ...
      this.workNumber=localStorage.getItem('work_number');
    ...
    methods: {
      ...
      exportData(da){
        window.open("/Views/admin/business/exportQuotation.aspx?T=quotation&id="+da.id)
      },
